...
public class DesUtils {
    ...
    public String encrypt(String source) {
        ...
        try {
            ...
            String result = "";
            if (code == 0) {
                result = new String(retByte, StandardCharsets.ISO_8859_1);
            } else if (code == 1) {
                result = Base64.encodeToString(retByte, Base64.NO_WRAP);
            } else {
    ...
    public String decrypt(String encrypted) {
        ...
        try {
            ...
            if (code == 0) {
                retByte = encrypted.getBytes(StandardCharsets.ISO_8859_1);
            } else if (code == 1) {
                retByte = Base64.decode(encrypted, Base64.NO_WRAP);
            } else {
